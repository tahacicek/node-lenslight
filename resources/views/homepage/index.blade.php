        ...
        <div class="row">
            <div class="col-md-4">
                <div class="text-center mt-5">
                    <button class="btn-16" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom"
                        aria-controls="offcanvasBottom">Everything About Me</button>
                </div>
            </div>
            <div class="col-md-4">
                <div class="text-center mt-5">
                        ...
                        <div class="col-md-12">
                            <div class="card repository mt-2">
                                <div class="card-header">
                                    <h5><a target="_blank" href="https://github.com/tahacicek?tab=repositories"><b>Github
